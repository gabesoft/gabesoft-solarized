...
(defun gabesoft-solarized-create-theme (variant theme-name)
  ...
  (gabesoft-solarized-dyn-let
   ...
   (custom-theme-set-faces
    ...
    `(org-block-begin-line      ((,class (:foreground ,comment :background ,bg-base :bold nil :italic t))))
    `(org-block-end-line        ((,class (:foreground ,comment :background ,bg-base :bold nil :italic t))))
