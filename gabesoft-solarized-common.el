...
(defvar gabesoft-solarized-solarized-colors
  '((:base03  . ("#002b36" . ("#1c1c1c" . "black")))
    (:base02  . ("#073642" . ("#262626" . "black")))
    (:base01  . ("#586e75" . ("#4e4e4e" . "green")))
    (:base00  . ("#657b83" . ("#585858" . "yellow")))
    (:base0   . ("#839496" . ("#808080" . "blue")))
    (:base1   . ("#93a1a1" . ("#8a8a8a" . "cyan")))
    (:base2   . ("#eee8d5" . ("#d7d7af" . "white")))
    (:base3   . ("#fdf6e3" . ("#ffffd7" . "white")))
    (:yellow  . ("#b58900" . ("#af8700" . "yellow")))
    (:orange  . ("#cb4b16" . ("#d75f00" . "red")))
    (:red     . ("#dc322f" . ("#d70000" . "red")))
    (:magenta . ("#d33682" . ("#af005f" . "magenta")))
    (:violet  . ("#6c71c4" . ("#5f5faf" . "magenta")))
...
(defun gabesoft-solarized-get-256-color (name)
  "Get the terminal value for the color with NAME."
  (car (cdr (gabesoft-solarized-get-color-value name))))

(defun gabesoft-solarized-get-8-color (name)
  "Get the terminal value for the color with NAME."
  (cdr (cdr (gabesoft-solarized-get-color-value name))))
...
(defun gabesoft-solarized-get-color (name)
  ...
  (if (gabesoft-solarized-gui-color-p)
    ...
    (gabesoft-solarized-get-256-color name)))
...
(defun gabesoft-solarized-create-theme (variant theme-name)
  ...
  (gabesoft-solarized-dyn-let ((class '((class color) (min-colors 89)))

                               (class-true-color-88 '((class color) (min-colors 88)))
                               (class-true-color-16 '((class color) (min-colors 16)))
                               (class-true-color-8 '((class color) (min-colors 8)))
