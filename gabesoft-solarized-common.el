...
(defun gabesoft-solarized-create-theme (variant theme-name)
  ...
  (gabesoft-solarized-dyn-let
   ((class '((class color) (min-colors 89)))
    ...
    (doc-bg   (gabesoft-solarized-get-color-for-variant variant :bg-base))
   ...
   (custom-theme-set-faces
    ...
    `(link                           ((,class (:foreground unspecified :underline nil :italic t :bold t))))
    `(link-visited                   ((,class (:foreground unspecified :underline nil :italic t :bold t))))
    ...
    `(font-lock-doc-face               ((,class (:foreground ,doc :background ,doc-bg :italic t :bold nil))))
    ...
    ;; avy
    `(avy-lead-face   ((,class (:background ,bg-base :foreground ,magenta :bold t))))
    `(avy-lead-face-0 ((,class (:background ,bg-base :foreground ,blue :bold t))))
    `(avy-lead-face-1 ((,class (:background ,bg-base :foreground ,yellow :bold t))))
    `(avy-lead-face-2 ((,class (:background ,bg-base :foreground ,green :bold t))))
    ...
    `(helm-match                               ((,class (:foreground ,mat :background ,bg-base :bold t))))
    `(helm-match-item                          ((,class (:foreground ,yellow :background ,bg-emph))))
    ...
    `(magit-blame-hash                  ((,class (:foreground ,cyan :background ,bg-emph ))))
    `(magit-blame-header                ((,class (:foreground ,green :background ,bg-emph ))))
    `(magit-blame-heading               ((,class (:foreground ,blue :background ,bg-emph ))))
    `(magit-blame-name                  ((,class (:foreground ,yellow :background ,bg-emph ))))
    `(magit-blame-sha1                  ((,class (:foreground ,violet :background ,bg-emph ))))
    `(magit-blame-subject               ((,class (:foreground ,yellow :background ,bg-emph ))))
    `(magit-blame-summary               ((,class (:foreground ,magenta :background ,bg-emph ))))
    `(magit-blame-time                  ((,class (:foreground ,green :background ,bg-emph ))))
    `(magit-branch                      ((,class (:foreground ,const :weight bold))))
    `(magit-branch-current              ((,class (:foreground ,blue :background ,bg-emph :inherit bold :box nil))))
    `(magit-branch-local                ((,class (:foreground ,blue :background ,bg-emph :inherit bold))))
    `(magit-branch-remote               ((,class (:foreground ,cyan :background ,bg-emph :inherit bold))))
    `(magit-diff-added                  ((,class (:foreground ,green :background ,bg-base :inverse-video t))))
    `(magit-diff-added-highlight        ((,class (:foreground ,green :background ,bg-emph :inverse-video t))))
    `(magit-diff-context-highlight      ((,class (:foreground ,fg-base :background ,bg-emph ))))
    `(magit-diff-context                ((,class (:foreground ,fg-base :background ,bg-base ))))
    `(magit-diff-file-header            ((,class (:foreground ,fg-emph :background ,bg-rev-base))))
    `(magit-diff-file-heading           ((,class (:foreground ,comment :background ,bg-emph ))))
    `(magit-diff-file-heading-highlight ((,class (:foreground ,comment :background ,bg-emph ))))
    `(magit-diff-hunk-header            ((,class (:foreground ,violet :background ,bg-emph ))))
    `(magit-diff-hunk-heading           ((,class (:foreground ,violet :background ,bg-emph ))))
    `(magit-diff-hunk-heading-highlight ((,class (:foreground ,violet :background ,bg-emph ))))
    `(magit-diff-removed                ((,class (:foreground ,red :background ,bg-base :inverse-video t))))
    `(magit-diff-removed-highlight      ((,class (:foreground ,red :background ,bg-emph :inverse-video t))))
    ...
    `(magit-log-head-label-head         ((,class (:foreground ,bg-base :background ,yellow :inherit bold))))
    `(magit-log-head-label-local        ((,class (:foreground ,bg-base :background ,green :inherit bold))))
    `(magit-log-head-label-remote       ((,class (:foreground ,bg-base :background ,violet :inherit bold))))
    `(magit-log-head-label-tags         ((,class (:foreground ,bg-base :background ,magenta :inherit bold))))
    `(magit-log-head-label-wip          ((,class (:foreground ,bg-base :background ,cyan :inherit bold))))
    ...
    `(magit-section-title               ((,class (:foreground ,keyword :background ,bg-base :inherit bold))))
    ...
    `(org-agenda-date-today     ((,class (:foreground ,keyword :height 1.4 :weight bold))))
    `(org-agenda-date-weekend   ((,class (:foreground ,fg-rev-emph :weight normal))))
    `(org-agenda-done           ((,class (:foreground ,bg-rev-emph))))
    `(org-agenda-structure      ((,class (:foreground ,fg-rev-base :background ,bg-rev-base :weight bold :box nil))))
    `(org-block                 ((,class (:foreground ,fg-base :background ,bg-base))))
    `(org-block-begin-line      ((,class (:foreground ,comment :background ,bg-base :bold nil :italic t :underline t))))
    `(org-block-end-line        ((,class (:foreground ,comment :background ,bg-base :bold nil :italic t :underline nil))))
    `(org-code                  ((,class (:foreground ,comment :background ,bg-emph :bold t))))
    `(org-date                  ((,class (:foreground ,var :underline t) )))
    `(org-document-info-keyword ((,class (:foreground ,func))))
    `(org-done                  ((,class (:foreground ,cyan :box nil :bold t))))
    `(org-headline-done         ((,class (:foreground ,green))))
    `(org-ellipsis              ((,class (:foreground ,builtin))))
    `(org-footnote              ((,class (:foreground ,fg-rev-emph :underline t))))
    `(org-hide                  ((,class (:foreground ,fg-rev-emph))))

    `(org-level-1 ((,class (:bold t :foreground ,blue :height 1.0))))
    `(org-level-2 ((,class (:bold t :foreground ,yellow :height 1.0))))
    `(org-level-3 ((,class (:bold t :foreground ,cyan :height 1.0))))
    `(org-level-4 ((,class (:bold nil :foreground ,green :height 1.0))))
    `(org-level-5 ((,class (:bold nil :foreground ,violet :height 1.0))))
    `(org-level-6 ((,class (:bold nil :foreground ,yellow :height 1.0))))
    `(org-level-7 ((,class (:bold nil :foreground ,green :height 1.0))))
    `(org-level-8 ((,class (:bold nil :foreground ,violet :height 1.0))))

    `(org-link            ((,class (:foreground ,type :underline t))))
    `(org-quote           ((,class (:inherit org-block :slant italic))))
    `(org-scheduled       ((,class (:foreground ,type))))
    `(org-scheduled-today ((,class (:foreground ,func :bold t :height 1.2))))
    `(org-sexp-date       ((,class (:foreground ,fg-rev-emph))))
    `(org-special-keyword ((,class (:foreground ,func))))
    `(org-table           ((,class (:inherit default))))
    `(org-target          ((,class (:background ,bg-emph :bold t))))
    `(org-todo            ((,class (:foreground ,orange :box nil :bold t))))
    ...
    ;; rainbow-delimiters
    `(rainbow-delimiters-depth-1-face   ((,class (:foreground ,blue :bold t))))
    `(rainbow-delimiters-depth-2-face   ((,class (:foreground ,yellow :bold t))))
    ...
    ;; speedbar
    `(speedbar-button-face    ((,class (:inherit default :foreground ,fg-emph))))
    ...
    `(speedbar-selected-face  ((,class (:inherit default :foreground ,yellow :underline t))))
