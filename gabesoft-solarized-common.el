...
(defun gabesoft-solarized-create-theme (variant theme-name)
  ...
  (gabesoft-solarized-dyn-let
   ...
   (custom-theme-set-faces
    ...
    `(org-block-begin-line ((,class (:foreground ,fg-base :background ,bg-emph :bold t :italic nil))))
    `(org-block-end-line ((,class (:foreground ,fg-base :background ,bg-emph :bold t :italic nil))))
